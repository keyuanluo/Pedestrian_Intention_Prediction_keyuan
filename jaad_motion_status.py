...
from utils.jaad_preprocessing_8input_4predict import *

import torch
from torch import nn
from torch.utils.data import TensorDataset, DataLoader
from torch.utils.tensorboard import SummaryWriter
from model.main_model_jaad_8_bbox import Model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bbox_input', type=int, default=8, help='dimension of bbox.')
