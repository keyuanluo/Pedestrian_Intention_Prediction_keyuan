...
from utils.jaad_preprocessing_bbox_bbox_motion_each_epoch_test import *

import torch
from torch import nn
from torch.utils.data import TensorDataset, DataLoader
from torch.utils.tensorboard import SummaryWriter
from model.main_model_jaad_bbox_bbox_motion_each_epoch_test import Model
...
def main(args):
    ...
    train(model, train_loader, valid_loader, test_loader, cls_criterion, reg_criterion, optimizer, checkpoint_filepath, writer, args=args)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='/media/robert/4TB-SSD/checkpoints/JAAD_02.pt', help='测试模式下指定 .pt 文件路径')
